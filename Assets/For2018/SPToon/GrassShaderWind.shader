Shader "Unlit/GrassShaderWind"
{
    Properties
    {
        ...
        _UVYOffset("_UVYOffset", Range(-1,1))=0
        
        _VerticalBillboarding("Vertical Restraints", Range(0, 1)) = 1
        //风
        [HideInInspector]_Wind("Wind",2D)="white"{}//突变风采样纹理
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // sample the texture
                fixed4 originCol = tex2D(_MainTex, i.mainTexUV);
                ...
                col*=originCol;
                col+=(i.mapVal*_Gloss*0.25*(i.uv.y+_UVYOffset));

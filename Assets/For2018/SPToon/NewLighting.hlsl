...
half4 NewUniversalFragmentPBR(half3 albedo,half alpha,float2 lightMapUV,half3 vertexSH,half3 worldNormal)
{

    half3 color = albedo * SAMPLE_GI(lightMapUV, vertexSH, worldNormal);
    return half4(color, alpha);

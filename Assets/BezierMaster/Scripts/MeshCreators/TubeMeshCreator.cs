...
{
    [Serializable]
    public class TubeMeshCreator : CreateMeshBase
    {
        ...
        /// <returns></returns>
        public static TubeMeshCreator CreateTubeMesh(BezierSpline spline)
        {
            var line = CreateInstance<TubeMeshCreator>();
        ...
        void CreateCaps(int startIndex)
        {
            ...
            for (int j = 0; j < widhtSegmentsCount; j++)
            {
                ...
                //float uvReceipt = fixTexture ? spline.GetLenghtFromStart(t) / spline.GetCurveLenght() : t;
            ...
            startPoint = spline.GetPointOnCurve(1);
